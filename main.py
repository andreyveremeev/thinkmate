...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        ...
        "/mode — switch AI mode\n"
        "  assistant, tutor, coder, summarizer, analyst, brainstorm\n"
        "/language — set response language\n"
...
def main() -> None:
    ...
    app.add_handler(CommandHandler("mentor", mentor_command))
    app.add_handler(CommandHandler("critic", critic_command))
    app.add_handler(CommandHandler("psychologist", psychologist_command))
    app.add_handler(CommandHandler("programmer", programmer_command))
